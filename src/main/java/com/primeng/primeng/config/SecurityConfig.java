    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        return http
                ...
                .exceptionHandling(ex -> ex
                        .authenticationEntryPoint(authEntryPoint) // errores de autenticación
                        .accessDeniedHandler(accessDeniedHandler) // errores de autorización
                )
                .build();
    }
